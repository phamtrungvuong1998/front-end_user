        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-md-6"><a href="?filter_status=all" type="button"
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td>admin</td>
                                    <td width="5%"><img src="@/assets/logo.png" alt="admin" class="zvn-thumb"></td>
                                    <td><a href="/change-status-active/1" type="button"
                                           class="btn btn-round btn-success">Active</a></td>
                                    <td width="10%">
                                    ...
                                    <td class="last">
                                        <div class="zvn-box-btn-filter">
                                            <a href="/form/1" type="button" class="btn btn-icon btn-success"
                                               data-toggle="tooltip" data-placement="top"
                                               data-original-title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="/delete/1" type="button"
                                ...
                                <tr class="odd pointer">
                                    ...
                                    <td>member</td>
                                    <td width="5%"><img src="@/assets/logo.png" alt="hailan" class="zvn-thumb"></td>
                                    <td><a href="/change-status-active/2" type="button"
                                           class="btn btn-round btn-success">Active</a></td>
                                    <td width="10%">
                                        <select name="select_change_attr" class="form-control"
                                    ...
                                    <td class="last">
                                        <div class="zvn-box-btn-filter">
                                            <a href="/form/2" type="button" class="btn btn-icon btn-success"
                                               data-toggle="tooltip" data-placement="top"
                                               data-original-title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="/delete/2" type="button"
                                               class="btn btn-icon btn-danger btn-delete" data-toggle="tooltip"
                                               data-placement="top" data-original-title="Delete">
                                                <i class="fa fa-trash"></i>
                                            </a>
